...
if (isset($email, $password)) {
    ...
    if (login($email, $password) == true) {
			...
			if($l_where == ""){
				$query = "SELECT *,'' as Pass from Usuarios_empleados where id_usuario = ".$GL_id_usuario." order by Nombre ASC";
			}
			else
			{
				$query = "SELECT *,'' as Pass from Usuarios_empleados" . $l_where . " and id_usuario = ".$GL_id_usuario." order by Nombre ASC";
			}
				...
				{
				$resultado = "NOOK";
				$lista_errores[] = array('Error' =>"Error al buscar empleados");
