...
require_once 'functions_proveedores.php';
...
if (isset($email, $password)) {
	...
	$query = "SELECT Unidad from Stock_proveedor where codprov = '".$GL_CodProv."' and Unidad <> '' group by Unidad order by Unidad ASC";
	...
	if(mysql_num_rows($result)) {
	 ...
	 {
		$resultado = "OK";
		//$lista_errores[] = array('Error' =>"Error al buscar Unidades");
